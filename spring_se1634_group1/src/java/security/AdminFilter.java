 ...
 * @author nvash
 */
@WebFilter(filterName = "AdminFilter", urlPatterns = {"/AccountManagerServlet", "/ConfigManagerServlet"})
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, 
      FilterChain chain) throws IOException, ServletException {
        ...
        if (isAdmin) {
            chain.doFilter(req, res); //Cho phép truy cập trang được yêu cầu
        } else { //Ngược lại, chuyển hướng về trang đăng nhập
